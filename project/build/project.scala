...
class BenchmarkProject(info: ProjectInfo) extends DefaultProject(info) {
  ...
  lazy val hawtdispatch = "org.fusesource.hawtdispatch" % "hawtdispatch-scala" % "1.12-SNAPSHOT"
  lazy val stompjms = "org.fusesource.stompjms" % "stompjms-client" % "1.13-SNAPSHOT"
